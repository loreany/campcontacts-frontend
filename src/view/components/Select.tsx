    ...
    <div>
      <div className='relative'>
        ...
        <RdxSelect.Root value={value} onValueChange={handleSelect}>
          <RdxSelect.Trigger
            className={cn(
              'bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 peer focus:border-gray-800 transition-all outline-none text-left relative pt-4',
          ...
          <RdxSelect.Portal>
            <RdxSelect.Content className='z-[80] overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-[0px_11px_20px_0px_rgba(0,0,0,0.10)]'>
              ...
              <RdxSelect.Viewport className='p-2'>
                {options.map((option) => (
                  <RdxSelect.Item
                    key={option.value}
                    value={option.value}
                    className='p-2 text-gray-800 text-sm data-[state=checked]:font- outline-none data-[highlighted]:bg-gray-50 rounded-lg transition-colors '
                  >
